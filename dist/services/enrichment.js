...
export async function enrichReceiptData(productDescription, merchantName, existingBrand, existingProductCode) {
    try {
        const prompt = `
...
export function standardizeBrand(brand) {
    if (!brand)
        return brand === null ? null : (brand === undefined ? null : '');
...
export function parseProductCategory(category) {
...
export function normalizeMerchantName(merchantName) {
    if (!merchantName)
        return merchantName === null ? null : (merchantName === undefined ? null : '');
